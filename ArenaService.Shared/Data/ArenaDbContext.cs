...
public class ArenaDbContext : DbContext
{
    ...
    public DbSet<BattleTicketPolicy> BattleTicketPolicies { get; set; }
    public DbSet<BattleTicketPurchaseLog> BattleTicketPurchaseLogs { get; set; }
    public DbSet<BattleTicketUsageLog> BattleTicketUsageLogs { get; set; }
    public DbSet<BattleTicketStatusPerRound> BattleTicketStatusesPerRound { get; set; }
    public DbSet<BattleTicketStatusPerSeason> BattleTicketStatusesPerSeason { get; set; }
    public DbSet<RefreshTicketPolicy> RefreshTicketPolicies { get; set; }
    public DbSet<RefreshTicketPurchaseLog> RefreshTicketPurchaseLogs { get; set; }
    public DbSet<RefreshTicketStatusPerRound> RefreshTicketStatusesPerRound { get; set; }
    public DbSet<RefreshTicketUsageLog> RefreshTicketUsageLogs { get; set; }
